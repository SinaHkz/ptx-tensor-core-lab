...
/*
 * Stage 06: cp.async pipeline helper.
 *
 * Delta vs stage 05 helper:
 *   - No lane-fragment formula change.
 *   - No mma.sync instruction change.
 *   - Shared-memory pointer/stride interface is unchanged; pipeline changes are
 *     handled in kernel staging logic.
 */
